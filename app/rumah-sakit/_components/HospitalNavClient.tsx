...
const NAV_LINKS = [
  { href: '/rumah-sakit/dashboard', label: 'Dashboard',        id: 'rs-nav-dashboard',  icon: '🏠' },
  { href: '/rumah-sakit/status',    label: 'Status Permintaan', id: 'rs-nav-status',     icon: '📋' },
  { href: '/rumah-sakit/deskripsi', label: 'Deskripsi Respons', id: 'rs-nav-deskripsi',  icon: '💉' },
  { href: '/rumah-sakit/profil',    label: 'Profil',            id: 'rs-nav-profil',     icon: '👤' },
]

export function HospitalNavClient({ profileName }: Props) {
